...
app.post("/submit", (req, res) => {
  const rndAdj=adj[Math.floor(Math.random*adj.length)];
  const rndNoun=noun[Math.floor(Math.random*noun.length)];
  res.render("index.ejs", { adjective: rndAdj, noun: rndNoun});
